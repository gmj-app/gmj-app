...
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoClassificationController as CreatorIntelligenceVideoClassificationController;
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoController as CreatorIntelligenceVideoController;
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoEditorialMetadataController as CreatorIntelligenceVideoEditorialMetadataController;
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoExportController as CreatorIntelligenceVideoExportController;
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoImportHistoryController as CreatorIntelligenceVideoImportHistoryController;
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoSnapshotController as CreatorIntelligenceVideoSnapshotController;
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoSnapshotExportController as CreatorIntelligenceVideoSnapshotExportController;
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoThumbnailMetadataController as CreatorIntelligenceVideoThumbnailMetadataController;
use App\Http\Controllers\SuperAdmin\CreatorIntelligence\CreatorVideoTitleMetadataController as CreatorIntelligenceVideoTitleMetadataController;
...
Route::prefix('superadmin/creator-intelligence')->name('superadmin.creator-intelligence.')->middleware(['auth', 'can:creator-intelligence.manage'])->group(function () {
    ...
    Route::resource('subjects', CreatorIntelligenceSubjectController::class);
    ...
    Route::get('videos/{creatorVideo}/imports', CreatorIntelligenceVideoImportHistoryController::class)->name('videos.imports.index');
    Route::put('videos/{creatorVideo}/classification', [CreatorIntelligenceVideoClassificationController::class, 'update'])->name('videos.classification.update');
    Route::put('videos/{creatorVideo}/title-metadata', [CreatorIntelligenceVideoTitleMetadataController::class, 'update'])->name('videos.title-metadata.update');
    Route::put('videos/{creatorVideo}/thumbnail-metadata', [CreatorIntelligenceVideoThumbnailMetadataController::class, 'update'])->name('videos.thumbnail-metadata.update');
    Route::put('videos/{creatorVideo}/editorial-metadata', [CreatorIntelligenceVideoEditorialMetadataController::class, 'update'])->name('videos.editorial-metadata.update');
    Route::resource('videos', CreatorIntelligenceVideoController::class)->only(['index', 'show', 'edit', 'update'])->parameters(['videos' => 'creatorVideo']);
...
Route::get('/@{creator:slug}/requests/{recommendation}', [RecommendationController::class, 'merged'])
    ->scopeBindings()
    ->name('recommendations.merged');
