...
{
    /**
     * @return array<string, array{name: string, creator_favorites_limit: int, suggestions_per_creator_limit: int}>
     */
    ...
    /**
     * @return array{name: string, creator_favorites_limit: int, suggestions_per_creator_limit: int}
     */
    ...
    /**
     * @return array{plan: string, label: string, creator_favorites_limit: int, suggestions_per_creator_limit: int}
     */
