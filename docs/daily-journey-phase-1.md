...
The single Phaser gameplay scene owns ready, play, pause, and game-over states. All art is generated from Phaser primitives at runtime: runner, hills, trail, rock, fire, trail sign, pit, Journey Star, and shield. There are no licensed media assets. This list is the Phase 1 asset manifest and each generated texture key can later be replaced by a project-owned file.
