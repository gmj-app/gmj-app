                ...
                <li class="relative border-l border-slate-700 pl-7 lg:border-l-0 lg:pl-0 lg:pt-12">
                    ...
                    <article class="h-full rounded-3xl border border-slate-800 bg-slate-900 p-5 shadow-xl shadow-slate-950/30">
                        <div class="min-h-52 rounded-2xl border border-slate-700/70 bg-slate-950 p-4 text-xs text-slate-300" aria-label="Example {{ strtolower($stage['title']) }} interface">
                            @if ($stage['type'] === 'form')
                                <p class="font-bold text-white">Topic or idea</p><div class="mt-2 rounded-lg border border-slate-700 p-2.5">React to SB19’s live arrangement of MANA</div><p class="mt-3 font-bold text-white">Optional link</p><div class="mt-2 rounded-lg border border-slate-800 p-2.5 text-slate-500">youtube.com/…</div><p class="mt-3 font-bold text-white">Why this matters</p><div class="mt-2 rounded-lg border border-slate-800 p-2.5 text-slate-500">The harmonies deserve a closer listen.</div><span class="mt-3 block rounded-lg bg-indigo-500 p-2.5 text-center font-bold text-white">Submit suggestion</span>
