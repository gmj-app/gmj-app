<section aria-labelledby="lifecycle-title" class="border-y border-slate-800 bg-slate-900/80 px-4 py-20 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl"><h2 id="lifecycle-title" class="text-center text-3xl font-extrabold sm:text-4xl">A suggestion does not disappear after the vote.</h2>
