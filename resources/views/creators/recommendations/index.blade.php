                                    ...
                                    <td class="px-3 py-4">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="min-w-0">
                                                ...
                                                @endif
                                                @if ($recommendation->reason)<p class="mt-1 text-xs text-slate-600 dark:text-slate-300">Guide context: {{ Str::limit($recommendation->reason, 120) }}</p>@endif
                                                @if ($recommendation->request_context)<p class="mt-1 text-xs text-slate-500">Earlier presentation context: {{ Str::limit($recommendation->request_context, 120) }}</p>@endif
