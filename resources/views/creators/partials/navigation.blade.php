<nav class="flex flex-wrap gap-2" aria-label="Creator dashboard">
    ...
    <a href="{{ route('creators.duplicates.index', $creator) }}" class="rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('creators.duplicates.*') ? 'bg-indigo-600 text-white' : 'bg-white text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50 dark:bg-slate-900 dark:text-slate-200 dark:ring-slate-700' }}">Possible Duplicates</a>
    <a href="{{ route('creators.reports.index', $creator) }}" class="rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('creators.reports.*') ? 'bg-indigo-600 text-white' : 'bg-white text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50 dark:bg-slate-900 dark:text-slate-200 dark:ring-slate-700' }}">Reported</a>
