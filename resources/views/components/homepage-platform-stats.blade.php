...
<dl
    ...
    {{ $attributes->class('inline-flex min-w-48 shrink-0 items-center justify-center self-center justify-self-center rounded-xl border border-slate-200/80 bg-white/60 px-4 py-2.5 text-slate-600 shadow-sm shadow-slate-950/5 backdrop-blur dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-300 lg:justify-self-end') }}
>
