...
class FaqPageTest extends TestCase
{
    ...
    public function test_faq_accurately_explains_the_current_free_mvp(): void
    {
        $this->get(route('faq'))
            ...
            ->assertSee('Basics')
            ->assertSee('Guide My Journey is a community request board for creators.')
            ...
            ->assertSee('Fans can submit requests for topics, questions, ideas, links, or YouTube videos.')
