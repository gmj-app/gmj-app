...
class FaqPageTest extends TestCase
{
    ...
    public function test_faq_accurately_explains_the_current_free_mvp(): void
    {
        $this->get(route('faq'))
            ...
            ->assertSee('If you unfavorite a creator, your active upvotes')
            ->assertSee('Suggestions and Voting')
            ->assertSee('Yes. If you suggest something you care about, you can also use one of your upvotes on it.')
            ->assertSee('its upvotes are released back to users.')
