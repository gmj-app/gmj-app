...
class HomepageTest extends TestCase
{
    ...
    public function test_public_navigation_and_static_pages_are_available(): void
    {
        $this->get('/')
            ...
            ->assertSee('mx-auto grid h-16 max-w-7xl min-w-0 grid-cols-[1fr_auto] items-center gap-2 px-4 sm:px-6 md:grid-cols-3 lg:px-8', false)
        ...
        $this->get('/faq')
            ...
            ->assertSee('Can I vote for my own suggestion?')
